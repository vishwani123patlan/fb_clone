    ...
    <div className="sticky top-0 z-50 bg-white flex items-center p-2 lg:px-5 shadow-md">
      ...
      <div className="flex items-center">
        <Image
          ...
          layout="fixed"
        />
        <div className="hidden md:flex flex ml-2 items-center rounded-full bg-gray-200 p-2">
      ...
      <div className="flex items-center sm:space-x-2 justify-end">
        <Image 
          ...
          height="40"
        />
        <p className="hidden md:inline whitespace-nowrap font-semibold pr-3">{session.user.name}</p>
